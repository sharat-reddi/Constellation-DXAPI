...
// interface for props
interface AreteansExtensionsSampleAccordionOperatorProps extends PConnFieldProps {
...
function Operator(props: AreteansExtensionsSampleAccordionOperatorProps) {
